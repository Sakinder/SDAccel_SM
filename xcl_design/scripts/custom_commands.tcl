namespace eval ZQ {
  ...
  proc hw_blockdesign_create_bd {{args ""}} {
    ...
    if {$run_help} {
      puts "Description:\n\
            ...
            xcl_design  -> used for 7Series Zynq Design only. Generate 7 Series Zynq with Board Part configuration and Carrier Board extended settings (if available). \n\
      ...
      puts "Usage:\n\
              ...
              -------------------------\n\
              \[-help\]               print help\n\
              \[-bd_name\]            Use one of the predefined names (def:fsys): fsys, msys, xcl_design, zusys \n\
  ...
  proc sw_run_hsi {{args ""}} {
    ...
    if {$run_help} {
      ...
      if {$ZQ::IS_xcl_design || $ZQ::IS_ZUSYS || $force_bin} {
        ...
        if {$run_bitmcs} {
          ...
          puts "\"xcl_design_bd.tcl\" for Systems with Zynq "
